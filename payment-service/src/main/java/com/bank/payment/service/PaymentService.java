...
public class PaymentService {
    ...
    public PaymentDto makePayment(PaymentDto dto) {
        System.out.println("PaymentService - makePayment called with: " + dto);
        ...
        if (result.getTransactionId() == null) {
            result.setTransactionId("TXN" + UUID.randomUUID().toString().substring(0, 8).toUpperCase());
        }
    ...
    public List<PaymentDto> getTransactionsByAccount(Long accountId) {
        System.out.println("PaymentService - getTransactionsByAccount called for accountId: " + accountId);
        
        if (accountId == null) {
            System.out.println("PaymentService - accountId is null, returning empty list");
            return List.of();
        }
    ...
    private PaymentDto toDto(Payment payment) {
        ...
        if (dto.getTransactionId() == null) {
            dto.setTransactionId("TXN" + UUID.randomUUID().toString().substring(0, 8).toUpperCase());
        }
